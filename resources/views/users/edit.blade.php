                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('users.update', $usuario->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="atencionSedeDiv" style="display: none;">
                                    <div class="form-group">
                                        <label for="tipo_atencion_sede">Tipo de Atención Sede</label>
                                        <abbr title="Campo obligatorio" class="required-indicator">*</abbr>
                                        <select id="tipo_atencion_sede" name="tipo_atencion_sede" class="form-control">
                                            <option value="">Seleccione una opción</option>
                                            <option value="1347" {{ $tipo_atencion == "1347" ? 'selected' : '' }}>Social</option>
                                            <option value="1348" {{ $tipo_atencion == "1348" ? 'selected' : '' }}>Jurídico</option>
                                            <option value="1349" {{ $tipo_atencion == "1349" ? 'selected' : '' }}>Psicología</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
