                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="tipo_servicio_id" name="tipo_servicio_id" class="form-control" required>
                                        ...
                                        <option value="{{ $tipo_servicio->id }}">{{ $tipo_servicio->nombre_servicio }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3" id="atencionSedeDiv" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <select id="tipo_atencion_sede" name="tipo_atencion_sede" class="form-control">
                                        ...
                                        <option value="1347">Social</option>
                                        <option value="1348">Jurídico</option>
                                        <option value="1349">Psicología</option>
                                    </select>
                                </div>
                            </div>
